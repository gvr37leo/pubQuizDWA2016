...
/***/ function(module, exports, __webpack_require__) {
	...
	var _scoreboard = __webpack_require__(222);
	...
	_reactDom2.default.render(_react2.default.createElement(_scoreboard2.default, null), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _roomStatus = __webpack_require__(223);
	
	var _roomStatus2 = _interopRequireDefault(_roomStatus);
	
	var _roomPicker = __webpack_require__(225);
	...
	var Scoreboard = function (_React$Component) {
	    ...
	    function Scoreboard() {
	        ...
	        _this.state = { subView: _react2.default.createElement(_roomPicker2.default, { webIO: _this.webIO }) };
	
	        _this.webIO.on('roomChanged', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_roomStatus2.default, { showAnswers: false, room: data.room }) });
	        });
	        _this.webIO.on('questions', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_roomStatus2.default, { showAnswers: true, room: data.room }) });
	        });
	        return _this;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teamStatus = __webpack_require__(224);
	...
	var ScoreDisplay = function (_React$Component) {
	    _inherits(ScoreDisplay, _React$Component);
	
	    function ScoreDisplay(props) {
	        _classCallCheck(this, ScoreDisplay);
	
	        return _possibleConstructorReturn(this, (ScoreDisplay.__proto__ || Object.getPrototypeOf(ScoreDisplay)).call(this, props));
	    }
	            ...
	            if (room) {
	                ...
	                try {
	                    for (var _iterator = room.teams[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                        ...
	                        teamElements.push(_react2.default.createElement(_teamStatus2.default, { showAnswers: this.props.showAnswers, key: team.id, team: team, webIO: this.props.webIO }));
	                    }
	                } catch (err) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeamDisplayer = function (_React$Component) {
	    _inherits(TeamDisplayer, _React$Component);
	
	    function TeamDisplayer(props) {
	        _classCallCheck(this, TeamDisplayer);
	
	        return _possibleConstructorReturn(this, (TeamDisplayer.__proto__ || Object.getPrototypeOf(TeamDisplayer)).call(this, props));
	    }
	
	    _createClass(TeamDisplayer, [{
	        key: 'render',
	        value: function render() {
	            var answer = null;
	            var style = 'primary';
	    ...
	    return TeamDisplayer;
	}(_react2.default.Component);
	
	exports.default = TeamDisplayer;
