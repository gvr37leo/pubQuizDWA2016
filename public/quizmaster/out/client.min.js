...
/***/ function(module, exports, __webpack_require__) {
	...
	var Quizmaster = function (_React$Component) {
	    ...
	    function Quizmaster(props) {
	        ...
	        // <RoomCreator />;
	        // <TeampApprover />
	        _this.state.subView = _react2.default.createElement(_questionApprover2.default, null);
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { value: this.state.roomPassword, onChange: this.roomPasswordChange.bind(this), type: 'text', className: 'form-control' }),
	                        _react2.default.createElement(
	                            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TeamApprover = function (_React$Component) {
	    ...
	    function TeamApprover(props) {
	        ...
	        _this.teams = [{ id: 1, name: 'cool' }, { id: 2, name: 'fruit' }];
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.teams[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    teamElements.push(_react2.default.createElement(_teamPanel2.default, { key: team.id, team: team }));
	                }
	            } catch (err) {
	        ...
	        value: function render() {
	            ...
	            if (!this.props.team.approved) {
	                button = _react2.default.createElement(
	                    'button',
	                    { onClick: this.btnApprovedClicked.bind(this), className: 'btn btn-default' },
	                    'X'
	                );
	            }
	            return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionSelector = function (_React$Component) {
	    ...
	    function QuestionSelector(props) {
	        ...
	        _this.state = {};
	        _this.state.questions = [{ id: 1, question: 'wie', category: 'culture' }, { id: 2, question: 'wat', category: 'culture' }, { id: 3, question: 'waar', category: 'culture' }];
	        return _this;
	    }
	    ...
	    _createClass(QuestionSelector, [{
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.state.questions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionApprover = function (_React$Component) {
	    ...
	    function QuestionApprover(props) {
	        ...
	        _this.state = {};
	        _this.state.answers = [{ id: 1, answer: 'hij', team: 'coolen boyz', approved: false }, { id: 2, answer: 'hullie', team: 'horp', approved: true }];
	        return _this;
	    }
	    ...
	    _createClass(QuestionApprover, [{
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.state.answers[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var answer = _step.value;
	
	                    answerElements.push(_react2.default.createElement(_teamAnswer2.default, { key: answer.id, answer: answer }));
	                }
	            } catch (err) {
	                _didIteratorError = true;
	                _iteratorError = err;
