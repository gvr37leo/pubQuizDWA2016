...
/***/ function(module, exports, __webpack_require__) {
	...
	var _quizmaster = __webpack_require__(222);
	
	var _quizmaster2 = _interopRequireDefault(_quizmaster);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var app = document.getElementById('app');
	_reactDom2.default.render(_react2.default.createElement(_quizmaster2.default, null), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _roomCreator = __webpack_require__(223);
	
	var _roomCreator2 = _interopRequireDefault(_roomCreator);
	
	var _teamApprover = __webpack_require__(224);
	
	var _teamApprover2 = _interopRequireDefault(_teamApprover);
	
	var _questionSelector = __webpack_require__(226);
	
	var _questionSelector2 = _interopRequireDefault(_questionSelector);
	
	var _questionApprover = __webpack_require__(228);
	
	var _questionApprover2 = _interopRequireDefault(_questionApprover);
	
	var _contNext = __webpack_require__(230);
	
	var _contNext2 = _interopRequireDefault(_contNext);
	...
	var WebIO = __webpack_require__(231);
	
	var Quizmaster = function (_React$Component) {
	    _inherits(Quizmaster, _React$Component);
	
	    function Quizmaster(props) {
	        _classCallCheck(this, Quizmaster);
	
	        var _this = _possibleConstructorReturn(this, (Quizmaster.__proto__ || Object.getPrototypeOf(Quizmaster)).call(this, props));
	
	        _this.stopBtnClicked = function () {
	            this.setState({ subView: _react2.default.createElement(_roomCreator2.default, { webIO: this.webIO }) });
	        };
	
	        _this.state = {};
	        var socket = new WebSocket("ws://localhost:8000/");
	        _this.webIO = new WebIO(socket);
	
	        _this.state.subView = _react2.default.createElement(_roomCreator2.default, { webIO: _this.webIO });
	
	        _this.webIO.on('endRound', function () {
	            _this.setState({ subView: _react2.default.createElement(_contNext2.default, { stopBtnClicked: _this.stopBtnClicked.bind(_this), webIO: _this.webIO }) });
	        });
	
	        _this.webIO.on('questions', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_questionSelector2.default, {
	                    questions: data.questions,
	                    webIO: _this.webIO })
	            });
	        });
	
	        _this.webIO.on('selectQuestion', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_questionApprover2.default, {
	                    webIO: _this.webIO,
	        ...
	        _this.webIO.on('roomUpdate', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_teamApprover2.default, { webIO: _this.webIO, room: data.room }) });
	        });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoomCreator = function (_React$Component) {
	    _inherits(RoomCreator, _React$Component);
	
	    function RoomCreator(props) {
	        _classCallCheck(this, RoomCreator);
	
	        var _this = _possibleConstructorReturn(this, (RoomCreator.__proto__ || Object.getPrototypeOf(RoomCreator)).call(this, props));
	
	        _this.state = {};
	        _this.state.roomPassword = "";
	
	        return _this;
	    }
	
	    _createClass(RoomCreator, [{
	        key: 'goBtnClicked',
	        value: function goBtnClicked() {
	            this.props.webIO.send('createRoom', {
	                password: this.state.roomPassword
	            });
	        }
	    }, {
	        key: 'roomPasswordChange',
	        value: function roomPasswordChange(event) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { value: this.state.roomPassword, placeholder: 'password', onChange: this.roomPasswordChange.bind(this), type: 'text', className: 'form-control' }),
	                        _react2.default.createElement(
	                            'button',
	                            { onClick: this.goBtnClicked.bind(this), className: 'btn btn-default' },
	                            'Go!'
	                        )
	                    )
	                )
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teamPanel = __webpack_require__(225);
	
	var _teamPanel2 = _interopRequireDefault(_teamPanel);
	...
	var TeamApprover = function (_React$Component) {
	    _inherits(TeamApprover, _React$Component);
	
	    function TeamApprover(props) {
	        _classCallCheck(this, TeamApprover);
	
	        var _this = _possibleConstructorReturn(this, (TeamApprover.__proto__ || Object.getPrototypeOf(TeamApprover)).call(this, props));
	
	        _this.state = {};
	
	        _this.audio = new Audio('./kahoot.mp3');
	    ...
	    _createClass(TeamApprover, [{
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = room.teams[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var team = _step.value;
	
	                    teamElements.push(_react2.default.createElement(_teamPanel2.default, { key: team.id, team: team, webIO: this.props.webIO }));
	                }
	            } catch (err) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        'div',
	                        { className: 'panel panel-primary', style: { marginRight: '40px', minWidth: '150px' } },
	                        _react2.default.createElement(
	                            'div',
	                            { className: 'panel-body' },
	                            _react2.default.createElement(
	                                'button',
	                                { onClick: this.goBtnClicked.bind(this), className: 'btn btn-success', style: { marginBottom: '10px' } },
	                                'Go!'
	                            ),
	                            _react2.default.createElement(
	                                'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var teamPanel = function (_React$Component) {
	    _inherits(teamPanel, _React$Component);
	
	    function teamPanel(props) {
	        _classCallCheck(this, teamPanel);
	
	        return _possibleConstructorReturn(this, (teamPanel.__proto__ || Object.getPrototypeOf(teamPanel)).call(this, props));
	    }
	
	    _createClass(teamPanel, [{
	        key: 'btnDeclinedClicked',
	        value: function btnDeclinedClicked(evt) {
	        ...
	        value: function render() {
	            ...
	            if (!this.props.team.approved) {
	                button = _react2.default.createElement(
	                    'button',
	                    { onClick: this.btnDeclinedClicked.bind(this), className: 'btn btn-default' },
	                    'X'
	                );
	            }
	            return _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _question = __webpack_require__(227);
	...
	var QuestionSelector = function (_React$Component) {
	    _inherits(QuestionSelector, _React$Component);
	
	    function QuestionSelector(props) {
	        _classCallCheck(this, QuestionSelector);
	
	        var _this = _possibleConstructorReturn(this, (QuestionSelector.__proto__ || Object.getPrototypeOf(QuestionSelector)).call(this, props));
	    ...
	    _createClass(QuestionSelector, [{
	        ...
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.props.questions[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    var question = _step.value;
	
	                    questionElements.push(_react2.default.createElement(_question2.default, {
	                        index: i,
	                        key: question._id,
	                        question: question,
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'div',
	                    { className: 'panel panel-primary', style: { padding: '40px', display: 'flex' } },
	                    questionElements
	                )
	            );
	        }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Question = function (_React$Component) {
	    ...
	    _createClass(Question, [{
	        key: 'btnQuestionClicked',
	        value: function btnQuestionClicked(evt) {
	        ...
	        value: function render() {
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    'button',
	                    { className: 'btn btn-success', onClick: this.btnQuestionClicked.bind(this),
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _teamAnswer = __webpack_require__(229);
	
	var _teamAnswer2 = _interopRequireDefault(_teamAnswer);
	...
	var QuestionApprover = function (_React$Component) {
	    _inherits(QuestionApprover, _React$Component);
	
	    function QuestionApprover(props) {
	        _classCallCheck(this, QuestionApprover);
	
	        var _this = _possibleConstructorReturn(this, (QuestionApprover.__proto__ || Object.getPrototypeOf(QuestionApprover)).call(this, props));
	
	        _this.state = {};
	        _this.state.teams = [];
	        _this.props.webIO.on('answerchanged', function (data) {
	            _this.setState({ teams: data.room.teams });
	        });
	        return _this;
	    }
	
	    _createClass(QuestionApprover, [{
	        key: 'btnNextQuestionClicked',
	        value: function btnNextQuestionClicked() {
	            this.props.webIO.send('roundStart', {});
	        }
	    }, {
	        key: 'render',
	        value: function render() {
	            ...
	            try {
	                for (var _iterator = this.state.teams[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
	                    ...
	                    teamElements.push(_react2.default.createElement(_teamAnswer2.default, { key: team.id, team: team, webIO: this.props.webIO }));
	                }
	            } catch (err) {
	                _didIteratorError = true;
	                _iteratorError = err;
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            ...
	                            _react2.default.createElement(
	                                'button',
	                                { onClick: this.btnNextQuestionClicked.bind(this), className: 'btn btn-success', style: { marginBottom: '10px' } },
	                                'Next'
	                            ),
	                            _react2.default.createElement(
	                                'div',
	    ...
	    return QuestionApprover;
	}(_react2.default.Component);
	
	exports.default = QuestionApprover;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var teamPanel = function (_React$Component) {
	    ...
	    _createClass(teamPanel, [{
	        key: 'btnApprovedClicked',
	        value: function btnApprovedClicked(evt) {
	        ...
	        value: function render() {
	            ...
	            if (!this.props.team.approved) {
	                ...
	                if (this.props.team.answer) {
	                    button = _react2.default.createElement(
	                        'button',
	                        { onClick: this.btnApprovedClicked.bind(this), className: 'btn btn-default', style: { marginLeft: '5px' } },
	            ...
	            return _react2.default.createElement(
	                'div',
	                { className: 'panel panel-' + style, style: { marginRight: '40px', minWidth: '150px' } },
	                _react2.default.createElement(
	                    'div',
	                    { className: 'panel-heading', style: { minHeight: '55px', display: 'flex', alignItems: 'center' } },
	                    this.props.team.name,
	                    button
	                ),
	                _react2.default.createElement(
...
/***/ function(module, exports, __webpack_require__) {
	...
	var ContNext = function (_React$Component) {
	    _inherits(ContNext, _React$Component);
	
	    function ContNext(props) {
	        _classCallCheck(this, ContNext);
	
	        var _this = _possibleConstructorReturn(this, (ContNext.__proto__ || Object.getPrototypeOf(ContNext)).call(this, props));
	    ...
	    _createClass(ContNext, [{
	        key: 'contBtnClicked',
	        value: function contBtnClicked() {
	            this.props.webIO.send('continue', {});
	        }
	    }, {
	        key: 'stopBtnClicked',
	        value: function stopBtnClicked() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'button',
	                            { onClick: this.contBtnClicked.bind(this), className: 'btn btn-default' },
	                            'Continue'
	                        ),
	                        _react2.default.createElement(
	                            'button',
	                            { onClick: this.stopBtnClicked.bind(this), className: 'btn btn-default' },
	                            'Stop'
	                        )
	                    )
	                )
...
/***/ function(module, exports) {
	...
	var WebIO = function () {
	    ...
	    _createClass(WebIO, [{
	        ...
	        key: "sendLastMessage",
	        value: function sendLastMessage() {
	        ...
	        value: function on(route, action) {
	            //actions need to be passed using an arrow function or functions binded with .bind(this)
	            this.routeMap[route] = action;
	        }
	    }, {
	        key: "send",
	        value: function send(route, value) {
	            //value is object en geserialized
	            value.route = route;
