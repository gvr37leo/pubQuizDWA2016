...
/***/ function(module, exports, __webpack_require__) {
	...
	var _team = __webpack_require__(222);
	...
	_reactDom2.default.render(_react2.default.createElement(_team2.default, null), app);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _roomPicker = __webpack_require__(223);
	
	var _roomPicker2 = _interopRequireDefault(_roomPicker);
	
	var _questionSubmitter = __webpack_require__(224);
	
	var _questionSubmitter2 = _interopRequireDefault(_questionSubmitter);
	
	var _waitingRoom = __webpack_require__(225);
	...
	var WebIO = __webpack_require__(226);
	...
	var Team = function (_React$Component) {
	    ...
	    function Team(props) {
	        ...
	        _this.state.subView = _react2.default.createElement(_roomPicker2.default, { webIO: _this.webIO, loginBtnClicked: _this.loginBtnClicked.bind(_this) });
	
	        var reconnect = function reconnect() {
	            console.log('trying to reconnect');
	            _this.webIO.socket = new WebSocket("ws://localhost:8000/");
	            _this.webIO.setupSocket();
	            _this.webIO.socket.onclose = socket.onclose;
	            _this.setState({ subView: _react2.default.createElement(_roomPicker2.default, { webIO: _this.webIO, loginBtnClicked: _this.loginBtnClicked.bind(_this) }) });
	        };
	        ...
	        _this.webIO.on('selectQuestion', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_questionSubmitter2.default, { question: data.question, webIO: _this.webIO, time: data.time }) });
	        });
	
	        _this.webIO.on('questions', function (data) {
	            _this.setState({ subView: _react2.default.createElement(_waitingRoom2.default, { webIO: _this.webIO }) });
	        });
	    ...
	    _createClass(Team, [{
	        ...
	        value: function loginBtnClicked() {
	            this.setState({ subView: _react2.default.createElement(_waitingRoom2.default, { webIO: this.webIO }) });
	        }
	    }, {
	        key: 'render',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var RoomPicker = function (_React$Component) {
	    _inherits(RoomPicker, _React$Component);
	
	    function RoomPicker(props) {
	        _classCallCheck(this, RoomPicker);
	
	        var _this = _possibleConstructorReturn(this, (RoomPicker.__proto__ || Object.getPrototypeOf(RoomPicker)).call(this, props));
	    ...
	    _createClass(RoomPicker, [{
	        key: 'roomIdChange',
	        value: function roomIdChange(event) {
	        ...
	        key: 'goBtnClicked',
	        value: function goBtnClicked(event) {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { value: this.state.roomId, onChange: this.roomIdChange.bind(this), type: 'text', placeholder: 'roomId', className: 'form-control' }),
	                        _react2.default.createElement('input', { value: this.state.roomPassword, onChange: this.roomPasswordChange.bind(this), type: 'text', placeholder: 'roomPassword', className: 'form-control' }),
	                        _react2.default.createElement('input', { value: this.state.name, onChange: this.nameChange.bind(this), type: 'text', placeholder: 'team name', className: 'form-control' }),
	                        _react2.default.createElement(
	                            'button',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var QuestionSubmitter = function (_React$Component) {
	    _inherits(QuestionSubmitter, _React$Component);
	
	    function QuestionSubmitter(props) {
	        _classCallCheck(this, QuestionSubmitter);
	
	        var _this = _possibleConstructorReturn(this, (QuestionSubmitter.__proto__ || Object.getPrototypeOf(QuestionSubmitter)).call(this, props));
	
	        _this.state = { allowedToSend: true };
	        setTimeout(function () {
	            this.setState({ allowedToSend: false });
	        }.bind(_this), _this.props.time * 1000);
	        return _this;
	    }
	
	    _createClass(QuestionSubmitter, [{
	        key: 'answerChange',
	        value: function answerChange(event) {
	            this.setState({ answer: event.target.value });
	        }
	    }, {
	        key: 'answerBtnClicked',
	        value: function answerBtnClicked() {
	            ...
	            return _react2.default.createElement(
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement('input', { value: this.state.answer, onChange: this.answerChange.bind(this), type: 'text', placeholder: 'Answer', className: 'form-control' }),
	                        _react2.default.createElement(
	                            'button',
	                            { disabled: !this.state.allowedToSend, onClick: this.answerBtnClicked.bind(this), className: 'btn btn-default' },
	                            'Answer'
	                        )
	                    )
	                )
	...
	exports.default = QuestionSubmitter;
	                ...
	                _react2.default.createElement(
	                    ...
	                    _react2.default.createElement(
	                        ...
	                        _react2.default.createElement(
	                            'p',
	                            null,
	                            'Wait for quizmaster to select a question'
	                        )
	                    ),
	                    _react2.default.createElement(
	                        'div',
	                        ...
	                        _react2.default.createElement(
	                            'center',
	                            null,
	                            _react2.default.createElement('img', { src: './loading_spinner.gif', alt: '' })
	                        )
	                    )
	                )
	            );
